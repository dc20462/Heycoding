...
<body>
	...
	<table border="1" width="550">
		...
		<c:if test="${not empty board.filename}">
			<tr>
				<th>첨부파일</th>
				<td><img src="upload/${board.filename}"></td>
			</tr>
		</c:if>
		<tr>
			<td colspan=2 align="center"><input type="button" value="수정"
				onclick="location.href='boardUpdateForm.do?bno=${board.bno}&page=${page}'">
				<input type="button" value="삭제"
				onclick="location.href='boardDelete.do?bno=${board.bno}&page=${page}'">
				<input type="button" value="목록보기"
				onclick="location.href='boardList.do'"> <!-- 기본 주소는 context밑임 -->
			</td>
		</tr>
	</table>
